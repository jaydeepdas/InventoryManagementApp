        ...
        <script>
            ...
            function addProductToCart(pid)
            {
               ...
               // alert("Quantity wanted = "+qty);
                //calling my servlet
                // window.location.href= "http://localhost:8080/InventoryManagementApp/AddProductToCart?productId="+pid+"&quantity="+qty;
                
            
            // ajax java ascronaous call
            //$ sign indicated that i am using jquarry
            //$. to use jquary
            $.ajax({
        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    <a class="nav-link px-3" href="Menu"><i class="fa" style="font-size:24px">&#xf218; <span id="result"></span></i></a>
                </div>
            </div>
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
